...
from services.audio.base import AudioService, TempFileManager
    ...
    def _process_audio_background(self, message_id: str, user_id: str, line_api: MessagingApi):
        ...
        try:
            ...
            try:
                ...
                logging.info(f"摘要生成完成，摘要長度: {len(summary_text)} 字符")
            except Exception as e:
